...
import { TERMINAL_BACKGROUND, TERMINAL_FOREGROUND } from "@/styles/terminal";
...
export function HermesConsoleModal({ open, onClose }: HermesConsoleModalProps) {
  ...
  return createPortal(
    <div
      ref={modalRef}
      className="fixed inset-0 z-[var(--z-modal)] flex items-center justify-center bg-background/85 p-3 sm:p-4"
