...
export const en: Translations = {
  ...
  sessions: {
    findSessionLastActive: "Last active",
    findSession: "Find a session",
    findSessionPlaceholder: "Search by title, id, or model...",
    findSessionConfirm: "resume",
    findSessionEmpty: "No sessions match that search",
    title: "Sessions",
    history: "History",
    overview: "Overview",
    filterChats: "Chats",
